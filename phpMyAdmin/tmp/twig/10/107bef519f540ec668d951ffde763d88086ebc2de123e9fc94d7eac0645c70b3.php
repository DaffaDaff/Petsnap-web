...
class __TwigTemplate_dcd3fc24182e81d95b43ce002a78a317821c5332e25c36efadd26ea179836807 extends Template
{
    private $source;
    private $macros = [];
  ...
  <td>
    ";
        ...
        if ((($context["has_execute_privilege"] ?? null) &&  !twig_test_empty(($context["execute_action"] ?? null)))) {
            // line 32
            echo "      ";
            if ((0 === twig_compare(($context["execute_action"] ?? null), "execute_routine"))) {
                // line 33
...
";
    ...
    {
        return new Source("", "database/routines/row.twig", "/var/www/html/phpMyAdmin/templates/database/routines/row.twig");
    }
}
